...
private:
    GLuint ShaderProgramID; // OpenGL-assigned shader program ID
    bool IsLinked = false; // Flag teling, whether shader program has been linked successfully
    std::map<std::string, Uniform> Uniforms; // Cache of uniform locations (reduces OpenGL calls)
};

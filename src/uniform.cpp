...
Uniform::Uniform(const std::string& name, ShaderProgram* shaderProgram) :
    Name(name),
    MasterShaderProgram(shaderProgram)
{
    Location = glGetUniformLocation(MasterShaderProgram->getShaderProgramID(), Name.c_str());
    if (Location == -1)
    {
...
{
    glUniform2fv(Location, 1, (GLfloat*)&vector2D);
}

void Uniform::set(const glm::vec2* vectors2D, int count)
{
    glUniform2fv(Location, count, (GLfloat*)vectors2D);
}
...
{
    glUniform3fv(Location, 1, (GLfloat*)&vector3D);
}

void Uniform::set(const glm::vec3* vectors3D, int count)
{
    glUniform3fv(Location, count, (GLfloat*)vectors3D);
}
...
{
    glUniform4fv(Location, 1, (GLfloat*)&vector4D);
}

void Uniform::set(const glm::vec4* vectors4D, int count)
{
    glUniform4fv(Location, count, (GLfloat*)vectors4D);
}
...
{
    glUniform1fv(Location, 1, (GLfloat*)&floatValue);
}

void Uniform::set(const float* floatValues, int count)
{
    glUniform1fv(Location, count, (GLfloat*)floatValues);
}
...
{
    glUniform1iv(Location, 1, (GLint*)&integerValue);
}

void Uniform::set(const int* integerValues, int count)
{
    glUniform1iv(Location, count, (GLint*)integerValues);
}

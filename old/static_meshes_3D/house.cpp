    ...
    , pyramid(withPositions, withTextureCoordinates, withNormals)
{
    ...
    std::call_once(prepareOnceFlag, []()
    {
        ...
        tm.loadTexture2D(WALLS_TEXTURE_KEY, "../textures/brick.png");
        tm.loadTexture2D(DOOR_WALL_TEXTURE_KEY, "../textures/house_texture_front.png");
        tm.loadTexture2D(WINDOWS_WALL_TEXTURE_KEY, "../textures/house_texture_side.png");
        tm.loadTexture2D(ROOF_TEXTURE_KEY, "../textures/prismarine_dark.png");
    });
}
